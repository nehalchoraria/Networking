# -*- coding: utf-8 -*-
"""
Created on Wed Feb 22 15:00:09 2017
...
newlist=[]
with open('C:/Users/Nehal/Desktop/ACN pracs/Router1.txt') as f:
    for line in f:
...
data_recv = pickle.loads(data)    #Received the packet
s.close()
...
for i in range(0,len(data_recv)):
    with open('C:/Users/Nehal/Desktop/ACN pracs/Router1.txt',"r+") as search:
        for line in search:
            if data_recv[i][5] in line:
                ...
                t=True
        if(t):
            print(Net_addr[i],Prefix[i],data_recv[i][4],"10.1.2.1",data_recv[i][5],file=search)
